          ...
          <div className="lg:col-span-7 flex flex-col space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-zinc-800/80">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm sm:text-base font-semibold">{about.stats.experience}</span>
              </div>
              <div className="flex items-center gap-3">
                <Globe2 className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-brand shrink-0" />
                <span className="text-sm sm:text-base font-semibold">{about.stats.export}</span>
              </div>
              <div className="flex items-center gap-3">
                <Award className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-brand shrink-0" />
                <span className="text-sm sm:text-base font-semibold">{about.stats.certified}</span>
              </div>
            </div>
          </div>
        </div>
